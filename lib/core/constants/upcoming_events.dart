...
List<Event> upcomingEvents = [
  Event(
      ...
      eventName: 'Introduction to User Interface Design',
      coHost: [
        Speaker(
          name: 'Danial',
          profileImage:
      ...
      eventDescription:
          'A Space for Novices to Pose Questions and Receive Guidance from More Experienced Community Members.',
      eventDate: 'Today, 6:00 pm',
      ticketAmount: 9,
      isOwner: true),
  Event(
    title: 'Camera Photography Fundamentals',
    eventName: 'Exploring the Basics of Photography with Cameras',
    coHost: [
      Speaker(
          name: 'Glenn',
          profileImage:
